This directory contains files and subdirectories for the ITS data analyses (cleaned up from private repos). Below is a description of the file to begin the analyses (`ITS_forward_metadata.tsv`)
